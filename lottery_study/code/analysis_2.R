...
stargazer(model_full, model_full_share, model_full_alt, model_full_share_alt, type = "html", 
          ...
          align = TRUE, 
          no.space = TRUE,
          omit = c("income", "black", "hispanic", "white", "gender", "marital", "urban", "employment", "religion", "education", "ideology", "state", "not_working_age", "early_working_age", "late_working_age", "retired"),  # Omit specified variables
          add.lines = list(
            c("Income controls", "Yes", "Yes", "Yes", "Yes"),
            c("Race controls", "Yes", "Yes", "Yes", "Yes"),
            c("Gender controls", "Yes", "Yes", "Yes", "Yes"),
            c("Marital status controls", "Yes", "Yes", "Yes", "Yes"),
            c("Urban controls", "Yes", "Yes", "Yes", "Yes"),
            c("Employment controls", "Yes", "Yes", "Yes", "Yes"),
            c("Religion controls", "Yes", "Yes", "Yes", "Yes"),
            c("Education controls", "Yes", "Yes", "Yes", "Yes"),
            c("Ideology controls", "Yes", "Yes", "Yes", "Yes"),
            c("State controls", "Yes", "Yes", "Yes", "Yes"),
            c("Age controls", "Yes", "Yes", "Yes", "Yes")
          )
)